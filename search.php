...
<head>
    ...
    <style>
        * { margin:0; padding:0; box-sizing:border-box; }
        ...
        .inquiry-btn { background: linear-gradient(135deg, #00D7B3 0%, #00D7B3 100%); color:#2E2E2E; border:none; padding:10px 24px; border-radius:25px; font-weight:700; cursor:pointer; text-decoration:none; display:inline-flex; align-items:center; gap:8px; font-size:14px; letter-spacing:0.5px; }
